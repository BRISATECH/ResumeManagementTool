...
##           Date1=Date1.replace("20","")
        ...
        ##"".join(tmp2)
          ...
          # Date2 = request.POST['datepicker1']
           ...
           print "date:::::",Date2
           vamsiram=Date2[:6]
           vamsiram=vamsiram+Date2[8:]
           print "vamsiram testingnxodf sof",vamsiram
##           Date2=Date2.replace("20","")
           Date2=vamsiram
           print "new D2=====",Date2
...
##           print "new DATE &&&&&&&&&  ",user_date1
           ...
           while(1):
             if flag1==0:
               ...
               if startDate == endDate:
                  break
           print "\n newwwwwwwwwwwwww   final list of dates______________",date_list
...
##              snehali=snehali+i[8:]
              ...
              user_date1=m+'/'+l+'/'+n
              datelist.append(user_date1)
           print "\n newwwwwwwwwwwwwwwwwww  datelist date n id ::" , datelist
